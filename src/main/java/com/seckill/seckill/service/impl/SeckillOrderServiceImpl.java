...
public class SeckillOrderServiceImpl implements SeckillOrderService {
    ...
    /** Lua 预扣 → 落流水消息 → 异步发送 */
    private void doSeckill(SeckillOrderDTO dto, SeckillActivity activity) {
    ...
    private void asyncSend(SeckillMessage message) {
        rocketMQTemplate.asyncSend(topic, message, new SendCallback() {
            ...
            public void onSuccess(SendResult sendResult) {
                messageMapper.update(null, new com.baomidou.mybatisplus.core.conditions.update.LambdaUpdateWrapper<LocalMessage>()
    ...
    private SeckillMessage buildMessage(SeckillOrderDTO dto, SeckillActivity activity) {
        ...
        message.setGoodsName(goods == null ? "" : goods.getGoodsName());
